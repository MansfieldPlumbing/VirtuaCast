...
ONNX_FILENAME = "..\models\student_128.onnx"
INPUT_IMAGE_SIZE = 128
EMBEDDING_SIZE = 512

# ==============================================================================
# === FINAL, CORRECTED MODEL ARCHITECTURE                                  ===
# ==============================================================================
...
class SELayer(nn.Module):
    def __init__(self, channel, reduction=16):
        ...
        self.fc = nn.Sequential(OrderedDict([
            # FIX: Set bias=False where it's missing in the blueprint
...
class Bottleneck(nn.Module):
    def __init__(self, channels):
        ...
        # FIX: Set bias=False for depthwise convolutions as per the error
...
class FaceSwapModel(nn.Module):
    def __init__(self, in_channels=3, embedding_size=512):
        ...
        # FIX: Structure matches blueprint names like 'enc1.0.weight', 'enc1.1.weight' perfectly
...
def main():
    ...
    print("Initializing final model architecture...")
    model = FaceSwapModel()

    print("Loading state dictionary with non-strict checking...")
    try:
        # --- FIX IS HERE ---
        # Changed strict=True to strict=False to ignore missing BatchNorm buffers
        model.load_state_dict(state_dict, strict=False)
        print("State dictionary loaded successfully! The architecture is a perfect match.")
    except Exception as e:
        print(f"CRITICAL ERROR: State dictionary mismatch. This should not happen. Error: {e}"); sys.exit(1)
    ...
    print(f"Exporting model to ONNX at '{onnx_path}' with correct settings...")
    try:
        torch.onnx.export(
            model,
            ...
            export_params=True,
            opset_version=12,
            do_constant_folding=False, # This remains the most important setting
        ...
        print("\n" + "="*60)
        print(f"SUCCESS: Model exported correctly to '{onnx_path}'")
        print("="*60 + "\n")
    except Exception as e:
